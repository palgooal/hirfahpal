<x-dashboard-layout>
        ...
        <div class="card">
            <div class="card-body d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-4">
                <div>
                    ...
                    <h4 class="mb-2">مرحباً بك في داشبورد الإدارة</h4>
                    <p class="text-muted mb-0">
                        هذه صفحة نظيفة جاهزة لبناء مشروعك الجديد داخل نفس قالب الداشبورد.
                    </p>
                </div>
    ...
    @foreach ([
        ...
        ['المستخدمون', 'حسب المشروع الجديد', 'info', 'ti-users'],
                    ...
                    <table class="table table-striped table-bordered mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>يمكنك الآن تركيب أقسام الداشبورد الخاصة بالمشروع الجديد.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="col-span-12 xl:col-span-4">
        <div class="card">
            ...
            <div class="card-body d-grid gap-2">
                <a href="{{ route('dashboard.home') }}" class="btn btn-outline-secondary">الرئيسية</a>
                @if (Route::has('dashboard.setting.index'))
                    <a href="{{ route('dashboard.setting.index') }}" class="btn btn-outline-secondary">الإعدادات</a>
                @endif
            </div>
        </div>
