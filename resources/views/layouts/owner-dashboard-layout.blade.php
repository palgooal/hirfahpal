@include('layouts.partials.owner-dashboard.head')
    <!-- [ Sidebar Menu ] start -->
    @include('layouts.partials.owner-dashboard.nav')
    <!-- [ Sidebar Menu ] end -->
    <!-- [ Header Topbar ] start -->
    @include('layouts.partials.owner-dashboard.header')
    <!-- [ Header ] end -->
    ...
    @include('layouts.partials.owner-dashboard.footer')
...
@include('layouts.partials.owner-dashboard.end')
